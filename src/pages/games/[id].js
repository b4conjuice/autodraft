      ...
      <Main className="space-y-2">
        <div className="text-center">
          <h1 className="space-x-2 text-2xl">
            <span className="space-x-1">
              <Link href="/teams/[id]" as={`/teams/${game.visitor_team.id}`}>
        ...
        {!game.stats ? (
          ...
          <>
            ...
            <BoxScore
              stats={game.stats.filter(s => s.team.id === game.visitor_team.id)}
            />
            <BoxScore
              stats={game.stats.filter(s => s.team.id === game.home_team.id)}
            />
          </>
        ) : null}
      </Main>
